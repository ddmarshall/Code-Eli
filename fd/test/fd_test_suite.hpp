...
class fd_test_suite : public Test::Suite
{
  ...
  private:
    void d1o1_test()
    {
      typedef eli::fd::d1o1<data__> d1o1_type;
    ...
    void d1o2_test()
    {
      typedef eli::fd::d1o2<data__> d1o2_type;
    ...
    void d1o3_test()
    {
      typedef eli::fd::d1o3<data__> d1o3_type;
      ...
      d1_driver("*** 1st Derivative, 3rd Order Left Mildly Non-Uniform Spacing ***", dx_factor, d1o3_type(d1o3_type::left));
    ...
    void d2o1_test()
    {
      typedef eli::fd::d2o1<data__> d2o1_type;
    ...
    void d2o2_test()
    {
      typedef eli::fd::d2o2<data__> d2o2_type;
