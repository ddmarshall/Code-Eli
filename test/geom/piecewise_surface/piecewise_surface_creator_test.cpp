...
#ifdef ELI_QD_FOUND
    ts.add(std::auto_ptr<Test::Suite>(new piecewise_surface_creator_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new piecewise_surface_creator_test_suite<qd_real>()));
#endif
