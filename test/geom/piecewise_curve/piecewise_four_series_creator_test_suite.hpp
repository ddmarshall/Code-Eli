...
class piecewise_four_series_creator_test_suite : public Test::Suite
{
  ...
  protected:
    ...
    {
      // add the tests
      TEST_ADD(piecewise_four_series_creator_test_suite<float>::create_point_test);
    }
    void AddTests(const double &)
    {
      // add the tests
      TEST_ADD(piecewise_four_series_creator_test_suite<double>::create_point_test);
    }
    void AddTests(const long double &)
    {
      // add the tests
      TEST_ADD(piecewise_four_series_creator_test_suite<long double>::create_point_test);
    }
