...
#include "piecewise_adaptive_airfoil_fitter_test_suite.hpp"         // piecewise_adaptive_fitter_test_suite
...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    //
    Test::Suite ts;
    std::string ostr_filename("piecewise_curve_fitter_test_results.html");

    // add the cppack test suites
    ts.add(std::auto_ptr<Test::Suite>(new piecewise_adaptive_airfoil_fitter_test_suite<float>()));
    ts.add(std::auto_ptr<Test::Suite>(new piecewise_adaptive_airfoil_fitter_test_suite<double>()));
    ts.add(std::auto_ptr<Test::Suite>(new piecewise_adaptive_airfoil_fitter_test_suite<long double>()));
