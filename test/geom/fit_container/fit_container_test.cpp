...
#include "fit_container_test_suite.hpp"  // fit_container_test_suite
...
#ifdef ELI_USING_QD
    ts.add(std::auto_ptr<Test::Suite>(new fit_container_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new fit_container_test_suite<qd_real>()));
#endif
