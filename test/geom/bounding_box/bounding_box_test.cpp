...
#include "bounding_box_test_suite.hpp"  // bounding_box_test_suite
...
#ifdef ELI_QD_FOUND
    ts.add(std::auto_ptr<Test::Suite>(new bounding_box_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new bounding_box_test_suite<qd_real>()));
#endif
