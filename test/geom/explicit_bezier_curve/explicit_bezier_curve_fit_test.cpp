...
#include "explicit_bezier_curve_fit_test_suite.hpp"  // explicit_bezier_curve_fit_test_suite
...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    //
    Test::Suite ts;
    std::string ostr_filename("explicit_bezier_curve_fit_test_results.html");

    // add the cppack test suites
    ts.add(std::auto_ptr<Test::Suite>(new explicit_bezier_curve_fit_test_suite<float>()));
    ts.add(std::auto_ptr<Test::Suite>(new explicit_bezier_curve_fit_test_suite<double>()));
    ts.add(std::auto_ptr<Test::Suite>(new explicit_bezier_curve_fit_test_suite<long double>()));
#ifdef ELI_USING_QD
    ts.add(std::auto_ptr<Test::Suite>(new explicit_bezier_curve_fit_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new explicit_bezier_curve_fit_test_suite<qd_real>()));
#endif
