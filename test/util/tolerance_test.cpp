...
#include "tolerance_test_suite.hpp"  // tolerance_test_suite
...
#ifdef ELI_QD_FOUND
    ts.add(std::auto_ptr<Test::Suite>(new tolerance_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new tolerance_test_suite<qd_real>()));
#endif
