...
#include "traits_test_suite.hpp"  // traits_test_suite
...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    //
    Test::Suite ts;
    std::string ostr_filename("traits_test_results.html");
...
#ifdef ELI_USING_QD
    ts.add(std::auto_ptr<Test::Suite>(new traits_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new traits_test_suite<qd_real>()));
#endif
