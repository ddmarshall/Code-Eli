...
class poly_math_test_suite : public Test::Suite
{
  protected:
    ...
    void AddTests(const dd_real &)
    {
      ...
      TEST_ADD(poly_math_test_suite<dd_real>::subtract_test);
      TEST_ADD(poly_math_test_suite<dd_real>::multiply_test);
      TEST_ADD(poly_math_test_suite<dd_real>::divide_test);
      TEST_ADD(poly_math_test_suite<dd_real>::creation_test);
      TEST_ADD(poly_math_test_suite<dd_real>::derivative_test);
    }

    void AddTests(const qd_real &)
    {
      TEST_ADD(poly_math_test_suite<qd_real>::add_test);
      TEST_ADD(poly_math_test_suite<qd_real>::subtract_test);
      TEST_ADD(poly_math_test_suite<qd_real>::multiply_test);
      TEST_ADD(poly_math_test_suite<qd_real>::divide_test);
      TEST_ADD(poly_math_test_suite<qd_real>::creation_test);
      TEST_ADD(poly_math_test_suite<qd_real>::derivative_test);
    }
#endif
  ...
  private:
    ...
    void add_test()
    {
      typename eli::poly::polynomial<data__>::coefficient_type coef1(4), coef2(3);
      ...
      eli::poly::polynomial<data__> p1(coef1), p2(coef2), pr;
      typename eli::poly::polynomial<data__>::data_type eval_out, eval_ref;
      typename eli::poly::polynomial<data__>::data_type x[5] = {0, 1, 6, 9, 15};
    ...
    void divide_test()
    {
      ...
      {
        typename eli::poly::polynomial<data__>::coefficient_type coef1(4), coef2(3), coef_q(2), coef_r(2), coef_out;
        ...
        // create polynomials
        eli::poly::polynomial<data__> p1(coef1), p2(coef2), pr, prem;
      ...
      {
        typename eli::poly::polynomial<data__>::coefficient_type coef1(4), coef2(2), coef_q(3), coef_r(1), coef_out;
      ...
      {
        typename eli::poly::polynomial<data__>::coefficient_type coef1(6), coef2(2), coef_q(5), coef_r(1), coef_out;
      ...
      {
        typename eli::poly::polynomial<data__>::coefficient_type coef1(6), coef2(3), coef_q(5), coef_r(2), coef_out;
    ...
    void creation_test()
    {
      ...
      {
        data__ roots(2);
        eli::poly::polynomial<data__> p(roots);
      ...
      {
        data__ roots[2] = {2, -3};
        eli::poly::polynomial<data__> p(roots[0], roots[1]);
      ...
      // create polynomial with 3 roots
      {
        ...
        eli::poly::polynomial<data__> p(roots[0], roots[1], roots[2]);
      ...
      // create polynomial with 4 roots
      {
        ...
        eli::poly::polynomial<data__> p(roots[0], roots[1], roots[2], roots[3]);

        typename eli::poly::polynomial<data__>::coefficient_type c;
      ...
      {
        data__ roots[4] = {2, -3, 5, 7};
        eli::poly::polynomial<data__> p(roots, roots+4);
    ...
    {
      typename eli::poly::polynomial<data__>::coefficient_type coef_in(4);

      // set coefficients
      coef_in << 3, 5, 1, 8;

      eli::poly::polynomial<data__> p1(coef_in);
      typename eli::poly::polynomial<data__>::data_type eval_out, eval_ref;
      typename eli::poly::polynomial<data__>::data_type t;

      {
        // test 1st derivative function
        eli::poly::polynomial<data__> *p2=p1.f();
        ...
        {
          typename eli::poly::polynomial<data__>::coefficient_type coef_ref, coef_out;
...

      {
        ...
        // test 1st derivative function
        eli::poly::polynomial<data__> *p2=p1.fp();
        ...
        {
          typename eli::poly::polynomial<data__>::coefficient_type coef_ref(3), coef_out;
...

      {
        ...
        eli::poly::polynomial<data__> *p2=p1.fpp();
        ...
        {
          typename eli::poly::polynomial<data__>::coefficient_type coef_ref(2), coef_out;
...

      {
        ...
        eli::poly::polynomial<data__> *p2=p1.fppp();
        ...
        {
          typename eli::poly::polynomial<data__>::coefficient_type coef_ref(1), coef_out;
