...
#include "fd_test_suite.hpp"  // fd_test_suite
...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    //
    Test::Suite ts;
    std::string ostr_filename("fd_test_results.html");
...
#ifdef ELI_USING_QD
    ts.add(std::auto_ptr<Test::Suite>(new fd_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new fd_test_suite<qd_real>()));
#endif
