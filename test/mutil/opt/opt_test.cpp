...
#include "least_squares_test_suite.hpp"  // least_squares_test_suite
...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    //
    Test::Suite ts;
    std::string ostr_filename("opt_test_results.html");
...
#ifdef ELI_QD_FOUND
    ts.add(std::auto_ptr<Test::Suite>(new least_squares_test_suite<dd_real>()));
    ts.add(std::auto_ptr<Test::Suite>(new least_squares_test_suite<qd_real>()));
#endif
