...
#ifndef eli_ad_dual_number_hpp
#define eli_ad_dual_number_hpp
    ...
    namespace dual_number
    {
      ...
      class expression
      {
        ...
        public:
          ...
          {
            eli::ad::dual<data_type, comp_real_only> d(this->real(), this->nonreal());
            return d==v;
          }
          bool operator==(const expression<T__, comp_real_only> &e) const
          {
            eli::ad::dual<data_type, comp_real_only> dl(this->real(), this->nonreal()), dr(e.real(), e.nonreal());
            return dl==dr;
          }
...
template <typename data2__, typename data__, bool comp_real_only>
bool operator==(const eli::ad::dual_number::constant<data2__> &c, const eli::ad::dual<data__, comp_real_only> &d)
{
  return d==c;
}
template <typename data2__, typename data__, bool comp_real_only>
...
template <typename data2__, typename data__, bool comp_real_only>
bool operator==(const eli::ad::dual_number::expression<data2__, comp_real_only> &e, const eli::ad::dual<data__, comp_real_only> &d)
{
  return d==e;
}
template <typename data2__, typename data__, bool comp_real_only>
...
// I/O functions
template <typename data__, bool comp_real_only>
std::ostream & operator<<(std::ostream &ostr, const eli::ad::dual<data__, comp_real_only> &d)
{
  d.print(ostr);
  return ostr;
}
...
template <typename data__, bool comp_real_only>
std::istream & operator>>(std::istream &istr, eli::ad::dual<data__, comp_real_only> &d)
{
  d.input(istr);
  return istr;
}
