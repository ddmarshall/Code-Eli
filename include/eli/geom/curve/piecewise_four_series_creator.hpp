...
namespace eli
{
  namespace geom
  {
    namespace curve
    {
      ...
      class piecewise_four_series_creator : public piecewise_creator_base<data__, dim__, tol__>
      {
        public:
          ...
          piecewise_four_series_creator() : piecewise_creator_base<data_type, dim__, tolerance_type>(2, 0), corner(3) {}
          piecewise_four_series_creator(const index_type &ns) : piecewise_creator_base<data_type, dim__, tolerance_type>(ns, 0), corner(ns+1) {}
