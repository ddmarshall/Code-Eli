...
#ifndef eli_geom_surface_piecewise_skinning_surface_creator_hpp
#define eli_geom_surface_piecewise_skinning_surface_creator_hpp
...
namespace eli
{
  namespace geom
  {
    namespace surface
    {
      ...
      bool create_skinning_surface(piecewise<bezier, data__, dim__, tol__> &ps,
